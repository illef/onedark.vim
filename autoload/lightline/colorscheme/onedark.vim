...
let s:bright_grey = [ '#b2b2b2', 249]

let s:p = {'normal': {}, 'inactive': {}, 'insert': {}, 'replace': {}, 'visual': {}, 'tabline': {}}
let s:p.normal.left = [ [ s:black, s:green ], [s:black, s:yellow], [ s:white, s:grey ] ]
let s:p.normal.right = [ [ s:grey, s:white ], [ s:white, s:grey ], [s:black, s:yellow],[s:black, s:red] ]
let s:p.inactive.left =  [ [ s:white, s:grey ], [ s:white, s:grey ] ]
let s:p.inactive.right = [ [ s:grey, s:white ], [ s:white, s:grey ],[s:black, s:yellow],[ s:black, s:white ] ]
let s:p.insert.left = [ [ s:black, s:blue ], [s:black, s:yellow],  [s:white, s:grey ] ]
let s:p.insert.right = [ [ s:grey, s:white ], [ s:white, s:grey ],[s:black, s:yellow],[ s:black, s:red ] ]
let s:p.replace.left = [ [ s:black, s:red ], [ s:white, s:grey ] ]
let s:p.replace.right = [ [ s:grey, s:white ], [ s:white, s:grey ],[s:black, s:yellow],[ s:white, s:grey ] ]
let s:p.visual.left = [ [ s:black, s:purple ], [s:black, s:yellow], [ s:white, s:grey ] ]
let s:p.visual.right = [ [ s:grey, s:white ], [ s:white, s:grey ],[s:black, s:yellow],[ s:black, s:red ] ]
